...
import com.strivve.Encryption;
import com.strivve.UncompressedPublicKeys;
...
public class EncryptionTest {
    ...
    public final static SecretKey integratorKey = Encryption.convertRawToAESKey(Base64.getDecoder().decode("OkzxB4HQit43k3OEbSYTAPG5hf96erAAlhb4prAjH/I="));
