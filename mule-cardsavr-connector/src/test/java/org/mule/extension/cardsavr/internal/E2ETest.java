...
public class E2ETest {
    ...
    /**
    @Test
    public void sessionTest() throws IOException, CardsavrRESTException {

    	LOGGER.info("Session test...");
        this.session = CardsavrConnection.createConnection(testConfig.integratorName, testConfig.integratorKey, testConfig.cardsavrServer, testConfig.proxy, testConfig.proxyCreds);
    ...
    */ 
    ...
    public void loginTest() throws IOException, CardsavrRESTException {
        ...
        this.session = CardsavrSession.createSession(testConfig.integratorName, testConfig.integratorKey, testConfig.cardsavrServer);
    ...
    public void filterError() throws IOException, CardsavrRESTException {
        ...
        CardsavrRESTException.Error[] errors = exception.getRESTErrors();
        assertEquals(1, errors.length);
        assertTrue(errors[0].toString().endsWith("Property: bad_filter"));
    }

    @Test
    public void jobPostTest() throws IOException, CardsavrRESTException, InterruptedException {
